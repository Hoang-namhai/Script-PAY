...
setHexMemory("libil2cpp.so", 0x2876d70, "20 2B A9 D2 00 70 80 F2 00 00 27 1E C0 03 5F D6")
setHexMemory("libil2cpp.so", 0x2875f4c, "20 2B A9 D2 00 70 80 F2 00 00 27 1E C0 03 5F D6")
setHexMemory("libil2cpp.so", 0x287683c, "20 2B A9 D2 00 70 80 F2 00 00 27 1E C0 03 5F D6")
gg.toast('✅𝙰𝙲𝚃𝙸𝚅𝙰𝚃𝙴𝙳✅')
end
